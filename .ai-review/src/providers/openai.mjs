// OpenAI + Azure OpenAI adapters. Uses REST directly (no SDK dependency).
// OpenAI env:        OPENAI_API_KEY
// Azure OpenAI env:  AZURE_OPENAI_API_KEY, AZURE_OPENAI_ENDPOINT, AZURE_OPENAI_DEPLOYMENT
...
export class AzureOpenAIProvider {
  ...
  async review({ system, user, temperature, maxOutputTokens }) {
